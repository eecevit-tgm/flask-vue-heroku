...
def test_login(client):
    response = client.post('login', {'username': 'eecevit', 'password': 'hallo'})
    print(response)
    # success
    # assertEquals(current_user.username, 'eecevit')
...
def test_singleUser(client):
    ...
    assert (res['username'] == "test01") and (res['email'] == "test01@student.tgm.ac.at") and (
            res['picture'] == "Tester0123")
    client.delete("/users/test01")


def test_addUser(client):
    client.pouserst("/users", json=user01)
    res = client.get("/users/test01")
    res02 = res.json[0]
    assert (res02['username'] == "test01") and (res02['email'] == "test01@student.tgm.ac.at") and (
            res02['picture'] == "Tester0123")
    client.delete("/users/test01")
...
def test_addMultiple(client):
    ...
    assert (res01['username'] == "test01") and (res01['email'] == "test01@student.tgm.ac.at") and (
            res01['picture'] == "Tester0123") and \
           (res02['username'] == "test02") and (res02['email'] == "test02@student.tgm.ac.at") and (
                   res02['picture'] == "Tester0123")
    client.delete("/users/test01")
...
def test_addMultiple02(client):
    ...
    assert (res01['username'] == "test01") and (res01['email'] == "test01@student.tgm.ac.at") and (
            res01['picture'] == "Tester0123") and \
           (res02['username'] == "test02") and (res02['email'] == "test02@student.tgm.ac.at") and (
                   res02['picture'] == "Tester0123") and \
           (res03['username'] == "test03") and (res03['email'] == "test03@student.tgm.ac.at") and (
                   res03['picture'] == "Tester0123")
...
def test_updateUser(client):
    ...
    res02 = res.json[0]
    assert (res02['username'] == "test02") and (res02['email'] == "test02@student.tgm.ac.at") and (
            res02['picture'] == "Tester0123")
